...
#from .twilio_settings import *  #twilio settings
...
SECRET_KEY = "django-insecure-m&8-e9zd2r89cq4fyq1ekh-c0#up5jz)de*kbvvzxisbvhp5-0"
...
AUTHENTICATION_BACKENDS = [
    'main.backends.PhoneNumberBackend',
